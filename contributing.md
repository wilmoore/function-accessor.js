# Contributing to function-accessor

Below are a few ways to make contributing to `function-accessor` smoother.
...
## Setup
    ...
    git clone https://github.com/wilmoore/function-accessor.js.git
    cd function-accessor.js
    npm install
    npm run dev
